...
export default function AddNewProjectComponent({handleAddTask}) {
  ...
  const [nameIsEmpty, setNameEmpty] = useState(false);
  const [dateIsEmpty, setDateIsEmpty] = useState(false);
  const [progressIsEmpty, setProgressIsEmpty] = useState(false);
            ...
            <form className="p-4 md:p-5" onSubmit={handleSubmit}>
              <div className="grid gap-4 mb-4 grid-cols-2">
                ...
                <div className="col-span-2">
                  ...
                  />
                  {dateIsEmpty && (<p className="text-red-500">* Please choose the deadline of your project.</p>)}
                  {dateIsError && (<p className="text-red-500">* Selected date connot be lower than current date.</p>)}
                </div>
                ...
                <div className="col-span-2">
                  ...
                  {progressIsEmpty && (<p className="text-red-500">* Please select your project progress.</p>)}
                </div>
                <div className="col-span-2">
                  <label
                    htmlFor="description"
